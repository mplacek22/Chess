...
void Board::initialize() {
    board_[0][0] = std::make_unique<Root>(Color::WHITE);
    ...
    board_[0][7] = std::make_unique<Root>(Color::WHITE);
    ...
    board_[7][0] = std::make_unique<Root>(Color::BLACK);
    ...
    board_[7][7] = std::make_unique<Root>(Color::BLACK);
}
